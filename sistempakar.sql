...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 12 Okt 2020 pada 02.41
...
--
-- Struktur dari tabel `data_latih_hama`
--
...
--
-- Dumping data untuk tabel `data_latih_hama`
--
...
--
-- Struktur dari tabel `data_latih_penyakit`
--
...
--
-- Dumping data untuk tabel `data_latih_penyakit`
--
...
--
-- Struktur dari tabel `hama_gejala`
--
...
--
-- Dumping data untuk tabel `hama_gejala`
--
...
--
-- Struktur dari tabel `hama_hama_gejala`
--
...
--
-- Dumping data untuk tabel `hama_hama_gejala`
--
...
--
-- Struktur dari tabel `penyakit_penyakit_gejala`
--
...
--
-- Dumping data untuk tabel `penyakit_penyakit_gejala`
--
...
--
-- Struktur dari tabel `riwayat_diagnosa_hama`
--
...
--
-- Dumping data untuk tabel `riwayat_diagnosa_hama`
--
...
--
-- Struktur dari tabel `riwayat_diagnosa_penyakit`
--
...
--
-- Dumping data untuk tabel `riwayat_diagnosa_penyakit`
--
...
(2, 'admin', 'admin', 'admin@gmail.com', NULL, '$2y$10$FmGf8I4mQAAx0idfMiBINu0MMZFye99gwswxKP2KGtCMx9dLC.WTC', 'BjYioyezeU9MrvbBH0pm9gomeKxz3Dp0V1RAmxmXsa92XGl9UMLTqoSOcH7J', '2020-06-26 01:55:56', '2020-10-11 17:31:04'),
...
--
-- Indeks untuk tabel `data_latih_hama`
--
ALTER TABLE `data_latih_hama`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `data_latih_penyakit`
--
...
--
-- Indeks untuk tabel `hama_gejala`
--
ALTER TABLE `hama_gejala`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `hama_hama_gejala`
--
...
--
-- Indeks untuk tabel `penyakit_penyakit_gejala`
--
ALTER TABLE `penyakit_penyakit_gejala`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `riwayat_diagnosa_hama`
--
ALTER TABLE `riwayat_diagnosa_hama`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `riwayat_diagnosa_penyakit`
--
...
--
-- AUTO_INCREMENT untuk tabel `data_latih_hama`
--
ALTER TABLE `data_latih_hama`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=144;

--
-- AUTO_INCREMENT untuk tabel `data_latih_penyakit`
--
ALTER TABLE `data_latih_penyakit`
...
--
-- AUTO_INCREMENT untuk tabel `hama_gejala`
--
ALTER TABLE `hama_gejala`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT untuk tabel `hama_hama_gejala`
--
ALTER TABLE `hama_hama_gejala`
...
--
-- AUTO_INCREMENT untuk tabel `penyakit_penyakit_gejala`
--
ALTER TABLE `penyakit_penyakit_gejala`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT untuk tabel `riwayat_diagnosa_hama`
--
ALTER TABLE `riwayat_diagnosa_hama`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;

--
-- AUTO_INCREMENT untuk tabel `riwayat_diagnosa_penyakit`
--
ALTER TABLE `riwayat_diagnosa_penyakit`
